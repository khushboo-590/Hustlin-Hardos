...
const BreakingNews = () => {
    return (
        <section className="bg-[#F6F0E2] py-10 lg:pb-[89px] md:pb-[40px]">
            <div className="max-w-[1140px] px-4 mx-auto mb-6 sm:mb-16">
                <h2 className="text-7xl max-xl:text-6xl max-lg:text-5xl max-md:text-3xl leading-[140%] font-semibold ">
            ...
            <div className="max-w-[1140px] mx-auto px-4 lg:border-l-2 border-black">
                <div className="flex flex-wrap items-center -mx-3">
                    <div className="w-full lg:w-1/2 px-3 py-5 lg:py-[86px]">
                        ...
                        <a
                            href="/"
                            className="text-base text-black hover:underline transition-all duration-300"
                        >
                            Read More...
                        </a>
                    </div>
                    <div className="w-full lg:w-1/2 px-3">
                        <img
                            src={manImg}
                            alt="Man "
                            className="w-full pointer-events-none object-cover pb-5 lg:pb-0"
                        />
                    </div>
                </div>
            </div>

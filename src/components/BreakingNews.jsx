...
const BreakingNews = () => {
    return (
        <div className=" bg-[#F6F0E2]">
            ...
            <div className="container lg:border-l-[2px] max-w-[1140px] px-3 mx-auto ">
                <div className="flex flex-wrap flex-row -mx-3 items-center">
                    <div className="px-4 lg:w-2/4 mx-auto lg:my-0 my-5 flex justify-center lg:py-[86px] py-5">
                        <div> <h4 className="text-base leading-[100%] text-black mb-4">March 1, 2022 by Editor Hardo</h4>
                            <Discripition myClass="text-lg leading-[150%] text-black lg:max-w-[475px] mb-4"
            ...
            <div className="border w-full lg:mb-[89px] mb-5"></div>
        </div>
